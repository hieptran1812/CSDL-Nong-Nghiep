...
const DecoratorBlob = tw(
  SvgDotPattern
)`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-blue-500`;
...
const Description = tw.p`mt-8 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-blue-100`;
...
const FeatureIconContainer = styled.div`
  ...
  ${props => [
    ...
    props.iconFilled && tw`border-0 bg-blue-500 text-blue-100`
  ]}
  svg {
    ${tw`w-5 h-5`}
  }
...
export default ({
  ...
  description = "Dễ dàng quản lý người dùng và thiết bị đo",
